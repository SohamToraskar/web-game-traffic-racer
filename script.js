...
$(function() {
    ...
    //intializing car and road dimensions
...
/*up key*/
    function up(){
      if(game_over === false && parseInt(car.css('top')) > 300){
...
/*down key*/
    function down(){
      if(game_over === false && parseInt(car.css('top')) < container_height - car_width - 30){
        car.css('top', parseInt(car.css('top')) + 5);
        move_down = requestAnimationFrame(down);
      }
    }
    ...
    function submitScore(){
      ...
      firebaseRef.child("Text").set(score_counter);
    }
